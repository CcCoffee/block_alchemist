...
- 🎯 世界目标：顶部同时展示 3 个目标（发现元素 / 凑齐图鉴 / 合成次数 / 累计积分），完成后奖励炼金点并自动刷新
- 🗂️ 目标分级：目标卡带「自然 / 文明 / 科技 / 神话」篇章标签，随世界等级逐步解锁，避免新手收到遥远目标
- 💡 卡住提示：连续失败几次或长时间没有新发现后，底部提示按钮亮起，点击获得一条合成线索
- 🔗 潜力徽标：材料栏方块上的 🔗N 表示它还能参与合成 N 种未知元素，指引下一步探索方向
- 🚒 灾害挑战：每种灾害都有救世配方，拖动对应救灾元素化解 +150 炼金点；限时未化解会爆发并扣 50 分
